...
outFile = open('./train.trees.pre.unk.rules_smooth_unk', 'w')
...
pickle.dump(grammar, open('grammar_smooth_unk.pkl', 'wb'))
pickle.dump(wordList, open('wordList_smooth_unk.pkl', 'wb'))
pickle.dump(N, open('N_smooth_unk.pkl', 'wb'))
