...
grammar = pickle.load(open('./grammar_smooth.pkl', 'rb'))
wordList = pickle.load(open('./wordList_smooth.pkl', 'rb'))
N = pickle.load(open('./N_smooth.pkl', 'rb'))

inpFile = open('./test.strings', 'r')
outFile = open('./test.parses_smooth', 'w')
