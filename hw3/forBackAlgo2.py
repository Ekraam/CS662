...
for iter in range(30):
    ...
    alphaMatrix = [[0 for y in range(Cols)] for x in range(Rows)]
    betaMatrix = [[0 for y in range(Cols)] for x in range(Rows)]
    alphaFinalState = 0
        ...
        for row in range(Rows):
            ...
            if col==0:
                ...
                for prevRow in range(Rows):
                    ...
                    alphaMatrix[row][col] += alphaMatrix[prevRow][col-1]*bigramProb[echarPrev][echar]
            else:
                cchar = inpLine[col//2]
